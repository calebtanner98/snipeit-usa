...
@section('title')
  @if($checkoutRequest)
  Checkout Accessory to {{$checkoutRequest->user->first_name}} {{$checkoutRequest->user->last_name}}
  @else
              ...
              <div class="form-group {{ $errors->has('checkout_qty') ? 'error' : '' }} ">
                  ...
                  <div class="col-md-7 col-sm-12 required">
                      <div class="col-md-2" style="padding-left:0px">
                          <input class="form-control" type="number" name="checkout_qty" id="checkout_qty" value="{{ old('checkout_qty', 1) }}" min="1" max="{{ $accessory->numRemaining() }}" readonly />
                      </div>
                  </div>
