...
@section('title')
  @if($checkoutRequest)
    Checkout Consumable to {{$checkoutRequest->user->first_name}} {{$checkoutRequest->user->last_name}}
  @else
          ...
          <div class="form-group {{ $errors->has('qty') ? 'error' : '' }} ">
              ...
              <div class="col-md-7 col-sm-12 required">
                ...
                <div class="col-md-2" style="padding-left: 0px">
                  <input class="form-control required col-md-12" type="text" name="qty" id="qty" value="{{ $checkoutRequest->quantity }}" readonly />
                </div>
              @else
              <div class="col-md-2" style="padding-left: 0px">
                <input class="form-control required col-md-12" type="text" name="qty" id="qty" value="{{ old('qty') ?? 1 }}" />
                </div>
              @endif
              </div>
