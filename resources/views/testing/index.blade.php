    ...
    <div class="flex-1 max-w-8xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 flex">
        ...
        <aside class="w-64 mr-8 hidden md:block">
            <nav class="space-y-1">
                ...
                <a href="{{ route('testing.components') }}"
                    class="w-full flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-5 w-5" viewBox="0 0 24 24"
                        fill="currentColor">
                        <path
                ...
                <a href="{{ route('testing.accessories') }}"
                    class="w-full flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-5 w-5" viewBox="0 0 24 24"
                        fill="currentColor">
                        <path
        ...
        <main class="flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($requestableAssets as $asset)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-600">Tag: {{ $asset->asset_tag }}</p>
                ...
                @endforeach
                @foreach ($requestableLicenses as $license)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-500"
                            ...
                            <p class="text-sm text-gray-600">Seats: {{ $license->freeSeats()->count() }}</p>
                ...
                @endforeach
                @foreach ($requestableAccessories as $accessory)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-500"
                            ...
                            <p class="text-sm text-gray-600">Category: {{ $accessory->category->name }}</p>
                            <span
                                class="inline-block mt-2 px-2 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-full">Available</span>
                        </div>
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 flex justify-between">
                ...
                @endforeach
                @foreach ($requestableComponents as $component)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-500"
