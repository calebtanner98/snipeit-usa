...
@section('title')
@if($checkoutRequest)
Checkout License to {{$checkoutRequest->user->first_name}} {{$checkoutRequest->user->last_name}}
@else
        ...
        <div class="col-md-7">
            <form class="form-horizontal" method="post" action="" autocomplete="off">
                ...
                <div class="box box-default">
                    ...
                    @else 
                        <x-redirect_submit_options index_route="licenses.index" :button_label="trans('general.checkout')" :options="[
