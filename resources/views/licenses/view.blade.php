    ...
    <div class="row">
                ...
                <ul class="nav nav-tabs hidden-print">
                    ...
                    <li>
                        <a href="#seats" data-toggle="tab">
                            ...
                            <span class="badge badge-secondary">{{ number_format($license->availCount()->count()) }} /
                                {{ number_format($license->seats) }}</span>
                    ...
                    "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","delete","download","icon"]
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-2" data-searchable="true" data-visible="true"
                                                data-field="filename" data-sortable="true">{{ trans('general.file_name') }}
                                            </th>
                                            <th class="col-md-1" data-searchable="true" data-visible="true"
                                                data-field="filesize">{{ trans('general.filesize') }}</th>
                                            <th class="col-md-2" data-searchable="true" data-visible="true"
                                                data-field="notes" data-sortable="true">{{ trans('general.notes') }}</th>
                                            <th class="col-md-1" data-searchable="true" data-visible="true"
                                        ...
                                        @if ($license->uploads->count() > 0)
                                            @foreach ($license->uploads as $file)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($file->filename)
                                                            @if (Storage::exists('private_uploads/licenses/' . $file->filename) &&
                                                                ...
                                                                <a href="{{ route('show.licensefile', ['licenseId' => $license->id, 'fileId' => $file->id, 'download' => 'false']) }}"
                                                                    data-toggle="lightbox" data-type="image"><img
                                                                        src="{{ route('show.licensefile', ['licenseId' => $license->id, 'fileId' => $file->id]) }}"
                                                    ...
                                                    <td
                                                        data-value="{{ Storage::exists('private_uploads/licenses/' . $file->filename) ? Storage::size('private_uploads/licenses/' . $file->filename) : '' }}">
                                                    ...
                                                    <td>
                                                        @if ($file->filename)
                                                            <a href="{{ route('show.licensefile', [$license->id, $file->id]) }}"
                                                                class="btn btn-sm btn-default">
                                                                <x-icon type="download" />
                                                                <span class="sr-only">{{ trans('general.download') }}</span>
                                                            </a>

                                                            <a href="{{ route('show.licensefile', [$license->id, $file->id, 'inline' => 'true']) }}"
                                                    ...
                                                    <td>
                                                        <a class="btn delete-asset btn-danger btn-sm"
                                                            href="{{ route('delete/licensefile', [$license->id, $file->id]) }}"
                                                            data-content="{{ trans('general.delete_confirm', ['item' => $file->filename]) }}"
        ...
        <div class="col-md-3">
            ...
            @can('checkout', $license)
                ...
                @else
                    <span data-tooltip="true"
                        title=" {{ trans('admin/licenses/general.bulk.checkout_all.disabled_tooltip') }}">
                        <a href="#" class="btn bg-maroon btn-sm btn-social btn-block hidden-print disabled"
                            style="margin-bottom: 5px;" data-tooltip="true" title="{{ trans('general.checkout') }}">
                            <x-icon type="checkout" />
                            {{ trans('general.checkout') }}
                        </a>
                    </span>
            ...
            @can('checkin', $license)
                ...
                @elseif (!$license->reassignable)
                    <span data-tooltip="true"
                        title=" {{ trans('admin/licenses/general.bulk.checkin_all.disabled_tooltip_reassignable') }}">
                        <a href="#" class="btn btn-primary bg-purple btn-sm btn-social btn-block hidden-print disabled"
                            style="margin-bottom: 25px;">
                            <x-icon type="checkin" />
                            {{ trans('admin/licenses/general.bulk.checkin_all.button') }}
                ...
                @else
                    <a href="#" class="btn btn-primary bg-purple btn-sm btn-social btn-block hidden-print"
                        ...
                        data-content="{{ trans('general.sure_to_delete') }} data-title="{{ trans('general.delete') }}"
