...
Route::group(['prefix' => 'licenses', 'middleware' => ['auth']], function () {
    ...
    Route::get('{licenseId}/checkout-request/{requestId}', 
    [Licenses\LicenseCheckoutController::class, 'create']
    )->name('licenses.checkout-request');

    Route::post(
        '{licenseId}/checkout-request/{requestId}',
        [Licenses\LicenseCheckoutController::class, 'storeCheckoutRequest']
    );
