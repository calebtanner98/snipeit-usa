...
Route::group(['prefix' => 'v1', 'middleware' => ['api', 'throttle:api']], function () {
    ...
    Route::group(['prefix' => 'account'], function () {
        ...
        )->name('api.waitlist.requestable');

        Route::get('profile/waitlist',
        [
            Api\ProfileController::class,
            'getProfileWaitlist'
        ]
        )->name('api.waitlist.profile');

        Route::get('waitlist-all',
        [
            Api\ProfileController::class,
            'getWaitlistAll'
        ]
        )->name('api.waitlist.all');
        ...
        Route::get('requests-licenses',
        [
            Api\ProfileController::class, 
            'requestedLicenses'
        ]
        )->name('api.licenses.requested');

        Route::get('requests-consumables',
        [
            Api\ProfileController::class, 
            'requestedConsumables'
        ]
        )->name('api.consumables.requested');
    ...
    Route::group(['prefix' => 'accessories'], function () {
        ...
        )->name('api.accessories.requested');   
