...
return [
    ...
    'Accessories' => [
        ...
        // // Added by USA Team to add permission to view accessories
        [
            'permission' => 'accessories.requestable.view',  // New permission
            'label'      => 'View Requestable Accessories',  
            'note'       => 'Allows viewing of requestable accessories', 
            'display'    => true, 
        ],
    ...
    'Consumables' => [
        ...
        // // Added by USA Team to add permission to view consumables
        [
            'permission' => 'consumables.requestable.view',  // New permission
            'label'      => 'View Requestable Consumables',  
            'note'       => 'Allows viewing of requestable comsumables', 
            'display'    => true, 
        ],
    ],
    ...
    'Licenses' => [
        ...
        // // Added by USA Team to add permission to view licenses
        [
            'permission' => 'licenses.requestable.view',  // New permission
            'label'      => 'View Requestable Licenses',  
            'note'       => 'Allows viewing of requestable licenses', 
            'display'    => true, 
        ],
    ],
    ...
    'Components' => [
        ...
        // // Added by USA Team to add permission to view accessories
        [
            'permission' => 'components.requestable.view',  // New permission
            'label'      => 'View Requestable Components',  
            'note'       => 'Allows viewing of requestable components', 
            'display'    => true, 
        ],
    ],
