<?php $__env->startSection('title'); ?>
  <?php if($checkoutRequest): ?>
    Checkout Consumable to <?php echo e($checkoutRequest->user->first_name); ?> <?php echo e($checkoutRequest->user->last_name); ?>
          ...
          <div class="form-group <?php echo e($errors->has('qty') ? 'error' : ''); ?> ">
              ...
              <div class="col-md-7 col-sm-12 required">
                ...
                <div class="col-md-2" style="padding-left: 0px">
                  <input class="form-control required col-md-12" type="text" name="qty" id="qty" value="<?php echo e($checkoutRequest->quantity); ?>" readonly />
                </div>
              <?php else: ?>
              <div class="col-md-2" style="padding-left: 0px">
                <input class="form-control required col-md-12" type="text" name="qty" id="qty" value="<?php echo e(old('qty') ?? 1); ?>" />
                </div>
              <?php endif; ?>
              </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '3f7b628a1a585b60fccfd7fdfdab6ee9::redirect_submit_options','data' => ['indexRoute' => 'consumables.index','buttonLabel' => trans('general.checkout'),'options' => [
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/snipeit/resources/views/consumables/checkout.blade.php ENDPATH**/ ?>