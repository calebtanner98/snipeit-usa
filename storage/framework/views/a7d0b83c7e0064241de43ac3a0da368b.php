...
<body class="min-h-screen bg-gray-100 flex flex-col">
    ...
    <div class="flex-1 max-w-8xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 flex">
        <!-- Left Sidebar -->
        ...
        <main class="flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $requestableLicenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $license): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Type: License</p>
                            <p class="text-sm text-gray-600">Seats: <?php echo e($license->freeSeats()->count()); ?></p>
                            <?php if($license->freeSeats()->count() > 1): ?>
                                <span
                                    class="inline-block mt-2 px-2 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-full">Available</span>
                            <?php else: ?>
                                <span
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $requestableAccessories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accessory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-500"
                            ...
                            <p class="text-sm text-gray-600 mt-1">Type: Accessory</p>
                            <p class="text-sm text-gray-600">Category: <?php echo e($accessory->category->name); ?></p>
                            <span
                                class="inline-block mt-2 px-2 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-full">Available</span>
                        </div>
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 flex justify-between">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $requestableComponents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-500"
                            ...
                            <p class="text-sm text-gray-600 mt-1">Type: Component</p>
                            <p class="text-sm text-gray-600">Category: <?php echo e($accessory->category->name); ?></p>
                            <span
                                class="inline-block mt-2 px-2 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-full">Available</span>
                        </div>
...
<?php /**PATH /var/www/html/snipeit/resources/views/testing/index.blade.php ENDPATH**/ ?>