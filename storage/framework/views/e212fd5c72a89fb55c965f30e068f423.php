<?php $__env->startSection('title'); ?>
  ...
  Checkout Accessory to <?php echo e($checkoutRequest->user->first_name); ?> <?php echo e($checkoutRequest->user->last_name); ?>
              ...
              <div class="form-group <?php echo e($errors->has('checkout_qty') ? 'error' : ''); ?> ">
                  ...
                  <div class="col-md-7 col-sm-12 required">
                      <div class="col-md-2" style="padding-left:0px">
                          <input class="form-control" type="number" name="checkout_qty" id="checkout_qty" value="<?php echo e(old('checkout_qty', 1)); ?>" min="1" max="<?php echo e($accessory->numRemaining()); ?>" readonly />
                      </div>
                  </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '3f7b628a1a585b60fccfd7fdfdab6ee9::redirect_submit_options','data' => ['indexRoute' => 'assets.requested','buttonLabel' => trans('general.checkout')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
       <?php else: ?> 
        <?php if (isset($component)) { $__componentOriginal897bfaf5cfb025541cae5f511fed1c5f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal897bfaf5cfb025541cae5f511fed1c5f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '3f7b628a1a585b60fccfd7fdfdab6ee9::redirect_submit_options','data' => ['indexRoute' => 'accessories.index','buttonLabel' => trans('general.checkout'),'options' => [
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/snipeit/resources/views/accessories/checkout.blade.php ENDPATH**/ ?>