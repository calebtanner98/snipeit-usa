<?php $__env->startSection('title'); ?>
    <?php if($checkoutRequest): ?>
        Checkout Asset to <?php echo e($checkoutRequest->user->first_name); ?> <?php echo e($checkoutRequest->user->last_name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '3f7b628a1a585b60fccfd7fdfdab6ee9::redirect_submit_options','data' => ['indexRoute' => 'hardware.index','buttonLabel' => trans('general.checkout'),'disabledSelect' => !$asset->model,'options' => [
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/snipeit/resources/views/hardware/checkout.blade.php ENDPATH**/ ?>