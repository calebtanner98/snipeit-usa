...
<?php endif; ?> <?php echo e(trans('general.loading')); ?> </h2>';
        ...
        function genericColumnObjLinkFormatter(destination) {
            return function(value, row) {
                if ((value) && (value.status_meta)) {
                    ...
                    return '<nobr><a href="<?php echo e(config('app.url')); ?>/' + dpolymorphicItemFormatterest + dest + '/' +
        ...
        function hardwareAuditFormatter(value, row) {
            return '<a href="<?php echo e(config('app.url')); ?>/hardware/audit/' + row.id +
                '/" class="btn btn-sm bg-yellow" data-tooltip="true" title="Audit this item"><?php echo e(trans('general.audit')); ?></a>';
        }
            ...
            return function(value, row) {
                ...
                if ((row.available_actions) && (row.available_actions.clone === true)) {
                    actions += '<a href="<?php echo e(config('app.url')); ?>/' + dest + '/' + row.id +
                        '/clone" class="actions btn btn-sm btn-info" data-tooltip="true" title="<?php echo e(trans('general.clone_item')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.clone_item')); ?></span></a>&nbsp;';
                ...
                if ((row.available_actions) && (row.available_actions.update === true)) {
                    actions += '<a href="<?php echo e(config('app.url')); ?>/' + dest + '/' + row.id +
                        '/edit" class="actions btn btn-sm btn-warning" data-tooltip="true" title="<?php echo e(trans('general.update')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.cannot_be_deleted')); ?></span></a></span>&nbsp;';
                ...
                if ((row.available_actions) && (row.available_actions.restore === true)) {
                    actions += '<form style="display: inline;" method="POST" action="<?php echo e(config('app.url')); ?>/' + dest +
                        '/' + row.id + '/restore"> ';
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.restore')); ?></span></button>&nbsp;';
        ...
        // This assetRequestActionsFormatter was moved to /account/requestable-assets.
        ...
        function minAmtFormatter(row, value) {
            ...
            if ((row) && (row != undefined)) {
                if (value.free_seats_count <= value.min_amt) {
                    return '<span class="text-danger text-bold" data-tooltip="true" title="<?php echo e(trans('admin/licenses/general.below_threshold_short')); ?>">' +
                        value.min_amt + '</span>';
                }
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('admin/hardware/general.deleted')); ?></span> <del><a href="<?php echo e(config('app.url')); ?>/hardware/' +
                        row.asset.id + '" data-tooltip="true" title="<?php echo e(trans('admin/hardware/general.deleted')); ?>">' + row
...
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '0bc333070fe8fbc263fd4a4e307b8773::icon','data' => ['type' => 'checkmark','class' => 'text-success']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
        ...
        function auditImageFormatter(value) {
            if (value) {
                return '<a href="' + value.url + '" data-toggle="lightbox" data-type="image"><img src="' + value.url +
                    '" style="max-height: <?php echo e($snipeSettings->thumbnail_max_h); ?>px; width: auto;" class="img-responsive"></a>'
            }
        }
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/test-deploy/resources/views/partials/bootstrap-table.blade.php ENDPATH**/ ?>