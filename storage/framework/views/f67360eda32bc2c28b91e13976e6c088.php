        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="box login-box" style="border-radius: 10px">
...
<?php endif; ?>
                        ...
                        <div class="box-footer" style="border-radius: 10px">
                            <?php if(config('app.require_saml')): ?>
...
<?php echo $__env->make('layouts/basic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/snipeit/resources/views/auth/login.blade.php ENDPATH**/ ?>