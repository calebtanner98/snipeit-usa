...
<div class="form-group <?php echo e($errors->has('qty') ? ' has-error' : ''); ?>">
    ...
    <div class="col-md-7<?php echo e((Helper::checkIfRequired($item, 'qty')) ? ' required' : ''); ?>">
       <div class="col-md-3" style="padding-left:0px">
           <input class="form-control" maxlength="5" type="text" name="qty" aria-label="qty" id="qty" value="<?php echo e(old('qty', $item->qty)); ?>" <?php echo (Helper::checkIfRequired($item, 'qty')) ? ' required ' : ''; ?>/>
       </div>
...
<?php /**PATH /var/www/html/test-deploy/resources/views/partials/forms/edit/quantity.blade.php ENDPATH**/ ?>