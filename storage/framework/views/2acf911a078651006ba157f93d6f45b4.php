...
<div class="form-group<?php echo e($errors->has('min_amt') ? ' has-error' : ''); ?>">
    ...
    <div class="col-md-9<?php echo e((Helper::checkIfRequired($item, 'min_amt')) ? ' required' : ''); ?>">
       <div class="col-md-2" style="padding-left:0px">
            <input class="form-control col-md-3" maxlength="5" type="text" name="min_amt" id="min_amt" aria-label="min_amt" value="<?php echo e(old('min_amt', $item->min_amt)); ?>" />
        </div>
...
<?php /**PATH /var/www/html/test-deploy/resources/views/partials/forms/edit/minimum_quantity.blade.php ENDPATH**/ ?>