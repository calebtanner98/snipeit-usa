...
<?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('index', \App\Models\Asset::class)): ?>
                        <a href="<?php echo e(route('hardware.index')); ?>" class="small-box-footer"><?php echo e(trans('general.view_all')); ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '0bc333070fe8fbc263fd4a4e307b8773::icon','data' => ['type' => 'arrow-circle-right']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-2 col-xs-6">
            <a href="<?php echo e(route('licenses.index')); ?>">
                <!-- small box -->
                <div class="dashboard small-box bg-maroon" style="border-radius: 12px">
                    <div class="inner">
...
<?php endif; ?>
        ...
        <div class="col-lg-2 col-xs-6">
            ...
            <a href="<?php echo e(route('accessories.index')); ?>">
                <div class="dashboard small-box bg-orange" style="border-radius: 12px">
                    <div class="inner">
...
<?php endif; ?>
        ...
        <div class="col-lg-2 col-xs-6">
            <a href="<?php echo e(route('users.index')); ?>">
                <!-- small box -->
                <div class="dashboard small-box bg-light-blue" style="border-radius: 12px">
                    <div class="inner">
                    ...
                    <div class="box-body">
                        <div class="row">
                                            ...
                                            <tr>
                                                <th data-field="icon" data-visible="true" style="width: 40px;"
                                                    class="hidden-xs" data-formatter="iconFormatter"><span
                                                        class="sr-only"><?php echo e(trans('admin/hardware/table.icon')); ?></span>
                                                </th>
                                                <th class="col-sm-3" data-visible="true" data-field="created_at"
                                                    data-formatter="dateDisplayFormatter"><?php echo e(trans('general.date')); ?></th>
                                                <th class="col-sm-2" data-visible="true" data-field="admin"
                                                    data-formatter="usersLinkObjFormatter"><?php echo e(trans('general.admin')); ?>

                                                </th>
                                                <th class="col-sm-2" data-visible="true" data-field="action_type">
                                                    <?php echo e(trans('general.action')); ?></th>
                                                <th class="col-sm-3" data-visible="true" data-field="item"
                                                    data-formatter="polymorphicItemFormatter"><?php echo e(trans('general.item')); ?>
                            ...
                            <div class="text-center col-md-12" style="padding-top: 10px;">
                                <a href="<?php echo e(route('reports.activity')); ?>" class="btn btn-primary btn-sm"
...
<?php endif; ?>
                                ...
                                <div class="text-center col-md-12" style="padding-top: 10px;">
                                    <a href="<?php echo e(route('locations.index')); ?>" class="btn btn-primary btn-sm"
                                        style="width: 100%"><?php echo e(trans('general.viewall')); ?></a>
                                </div>
                            </div> <!-- /.row -->
...
<?php endif; ?>
                            ...
                            <div class="text-center col-md-12" style="padding-top: 10px;">
                                <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-primary btn-sm"
                                    style="width: 100%"><?php echo e(trans('general.viewall')); ?></a>
                            </div>
                        </div> <!-- /.row -->
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/test-deploy/resources/views/dashboard.blade.php ENDPATH**/ ?>