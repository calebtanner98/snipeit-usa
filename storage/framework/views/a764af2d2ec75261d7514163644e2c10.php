                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php if(!$request->fulfilled_at && !$request->canceled_at): ?>
                                                                        ...
                                                                        <button type="button" class="btn btn-warning btn-sm"
                                                                                ...
                                                                                data-toggle="modal"
                                                                                data-target="#cancelAssetRequestModal-<?php echo e($request->id); ?>">
                                                                            <i class="fas fa-times"></i>
                                                                        </button>
                                                                        <!-- Cancel Asset Request Modal -->
                                                                        <div class="modal fade" id="cancelAssetRequestModal-<?php echo e($request->id); ?>" tabindex="-1" role="dialog" aria-labelledby="cancelAssetRequestModalLabel-<?php echo e($request->id); ?>">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        ...
                                                                                        <h4 class="modal-title" id="cancelAssetRequestModalLabel-<?php echo e($request->id); ?>"><?php echo e(trans('general.cancel_request')); ?></h4>
                                                                                    </div>
                                                                                    <div class="modal-body">
                                                                                        <form id="cancelAssetRequestForm-<?php echo e($request->id); ?>" method="POST" action="<?php echo e(route('account/request-item', [
                                                                                            $request->itemType(),
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <label for="cancelReason-<?php echo e($request->id); ?>" class="control-label">Reason For Cancellation</label>
                                                                                                <textarea class="form-control" id="cancelReason-<?php echo e($request->id); ?>" name="cancel_reason" rows="3"></textarea>
                                                                                            </div>
                                                                                        </form>
                                                                                    </div>
                                                                                    <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('general.close')); ?></button>
                                                                                        <button type="submit" form="cancelAssetRequestForm-<?php echo e($request->id); ?>" class="btn btn-warning">Submit</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                            ...
                                            "ignoreColumn": ["actions"]
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="col-md-2">
                                                            <?php echo e(trans('admin/hardware/table.requested_date')); ?></th>
                                                        <th class="col-md-2"><?php echo e(trans('general.status')); ?></th>
                                                                        ...
                                                                        <div class="modal fade" id="cancelLicenseModal" tabindex="-1" role="dialog" aria-labelledby="cancelLicenseModalLabel">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form id="cancelLicenseForm" method="POST" action="<?php echo e(config('app.url')); ?>/account/cancel-license-request/<?php echo e($request->license_id); ?>/<?php echo e($request->user_id); ?>">
                                                                                            <?php echo csrf_field(); ?>
                                                                                            <div class="form-group">
                                                    ...
                                                    <?php $__currentLoopData = $requestedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($request->canceled_at === null && $request->itemType() == 'accessory'): ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($request->accessory->numRemaining()); ?></td>
                                                                <td>
                                                                    <?php if($request->user): ?>
                                                                        <a
                                                                            href="<?php echo e(route('users.show', $request->user->id)); ?>">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-warning btn-sm"
                                                                            ...
                                                                            title="<?php echo e(trans('general.cancel_request')); ?>"
                                                                            data-toggle="modal"
                                                                            data-target="#cancelAccessoryRequestModal-<?php echo e($request->id); ?>">
                                                                        <i class="fas fa-times"></i>
                                                                    </button>
                                                                    <!-- Cancel Request Modal -->
                                                                    <div class="modal fade" id="cancelAccessoryRequestModal-<?php echo e($request->id); ?>" tabindex="-1" role="dialog" aria-labelledby="cancelRequestModalLabel-<?php echo e($request->id); ?>">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    ...
                                                                                    <h4 class="modal-title" id="cancelRequestModalLabel-<?php echo e($request->id); ?>"><?php echo e(trans('general.cancel_request')); ?></h4>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <form id="cancelRequestModalForm-<?php echo e($request->id); ?>" method="POST" action="<?php echo e(config('app.url')); ?>/accessories/cancel-request/<?php echo e($request->id); ?>">
                                                                                        <?php echo csrf_field(); ?>
                                                                                        <div class="form-group">
                                                                                            <label for="cancelReason-<?php echo e($request->id); ?>" class="control-label">Cancellation Reason</label>
                                                                                            <textarea class="form-control" id="cancelReason-<?php echo e($request->id); ?>" name="cancel_reason" rows="3"></textarea>
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <button type="submit" form="cancelRequestModalForm-<?php echo e($request->id); ?>" class="btn btn-warning">Submit</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-warning btn-sm"
                                                                            ...
                                                                            title="<?php echo e(trans('general.cancel_request')); ?>"
                                                                            data-toggle="modal"
                                                                            data-target="#cancelComponentRequestModal-<?php echo e($request->id); ?>">
                                                                        <i class="fas fa-times"></i>
                                                                    </button>
                                                                    <!-- Cancel Request Modal -->
                                                                    <div class="modal fade" id="cancelComponentRequestModal-<?php echo e($request->id); ?>" tabindex="-1" role="dialog"   aria-labelledby="cancelComponentRequestModalLabel-<?php echo e($request->id); ?>">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    ...
                                                                                    <h4 class="modal-title" id="cancelComponentRequestModalLabel-<?php echo e($request->id); ?>"><?php echo e(trans('general.cancel_request')); ?></h4>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <form id="cancelComponentRequestForm-<?php echo e($request->id); ?>" method="POST" action="<?php echo e(config('app.url')); ?>/components/cancel-request/<?php echo e($request->id); ?>">
                                                                                        <?php echo csrf_field(); ?>
                                                                                        <div class="form-group">
                                                                                            <label for="cancelReason-<?php echo e($request->id); ?>" class="control-label">Reason For Cancellation</label>
                                                                                            <textarea class="form-control" id="cancelReason-<?php echo e($request->id); ?>" name="cancel_reason" rows="3"></textarea>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('general.close')); ?></button>
                                                                                    <button type="submit" form="cancelComponentRequestForm-<?php echo e($request->id); ?>" class="btn btn-warning">Submit</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-warning btn-sm"
                                                                            ...
                                                                            title="<?php echo e(trans('general.cancel_request')); ?>"
                                                                            data-toggle="modal"
                                                                            data-target="#cancelConsumableRequestModal-<?php echo e($request->id); ?>">
                                                                        <i class="fas fa-times"></i>
                                                                    </button>
                                                                    <!-- Cancel Request Modal -->
                                                                    <div class="modal fade" id="cancelConsumableRequestModal-<?php echo e($request->id); ?>" tabindex="-1" role="dialog" aria-labelledby="cancelConsumableRequestModalLabel-<?php echo e($request->id); ?>">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    ...
                                                                                    <h4 class="modal-title" id="cancelConsumableRequestModalLabel-<?php echo e($request->id); ?>"><?php echo e(trans('general.cancel_request')); ?></h4>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <form id="cancelConsumableRequestForm-<?php echo e($request->id); ?>" method="POST" action="<?php echo e(config('app.url')); ?>/consumables/cancel-request/<?php echo e($request->id); ?>">
                                                                                        <?php echo csrf_field(); ?>
                                                                                        <div class="form-group">
                                                                                            <label for="cancelReason-<?php echo e($request->id); ?>" class="control-label">Reason For Cancellation</label>
                                                                                            <textarea class="form-control" id="cancelReason-<?php echo e($request->id); ?>" name="cancel_reason" rows="3"></textarea>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('general.close')); ?></button>
                                                                                    <button type="submit" form="cancelConsumableRequestForm-<?php echo e($request->id); ?>" class="btn btn-warning">Submit</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/snipeit/resources/views/hardware/requested.blade.php ENDPATH**/ ?>