...
class AssetsController extends Controller
{
    ...
    public function update(ImageUploadRequest $request, $assetId = null) : RedirectResponse
    {
        ...
        // Added by USA Team - Fixed the requestable option not being updated on save
    ...
    public function getRequestedIndex($user_id = null)
    {
        ...
        $pendingAssetRequestCount = CheckoutRequest::whereNotNull('requestable_id')->whereNull('canceled_at')->whereNull('fulfilled_at')->count();
        $pendingLicenseRequestCount = CheckoutRequest::whereNotNull('license_id')->whereNull('canceled_at')->whereNull('fulfilled_at')->count();
        $pendingAccessoryRequestCount = CheckoutRequest::whereNotNull('accessory_id')->whereNull('canceled_at')->whereNull('fulfilled_at')->count();
        $pendingComponentRequestCount = CheckoutRequest::whereNotNull('component_id')->whereNull('canceled_at')->whereNull('fulfilled_at')->count();
        $pendingConsumableRequestCount = CheckoutRequest::whereNotNull('consumable_id')->whereNull('canceled_at')->whereNull('fulfilled_at')->count();
        $waitlistItems = WaitList::whereNull('canceled_at')->whereNull('closed_at')->whereNull('denied_at')->get();
        ...
        return view('hardware/requested', compact('requestedItems', 'pendingAssetRequestCount', 'waitlistItems', 'pendingLicenseRequestCount', 'pendingAccessoryRequestCount', 'pendingComponentRequestCount', 'pendingConsumableRequestCount'));
    }
}