...
class Component extends SnipeModel
{
    ...
    // Added By USA Team For Request Component Functionality
    ...
    {
        return $this->hasMany(CheckoutRequest::class, 'component_id')->whereNull('canceled_at')->whereNull('fulfilled_at')
        ->whereNull('checkedin_at');;
    }
    
    public function cancelRequest($userId, $componentId, $cancelReason = null)
    {
        $checkoutRequest = $this->requests()->where('user_id', $userId)->where('component_id', $componentId)->first();
        ...
        $requestName = $checkoutRequest->component->name;
    ...
    // End Request Component Functionality
}