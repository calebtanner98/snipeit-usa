...
class Consumable extends SnipeModel
{
    ...
    // Added By USA Team For Request Consumable Functionality
    ...
    {
        return $this->hasMany(CheckoutRequest::class, 'consumable_id')->whereNull('canceled_at')->whereNull('fulfilled_at')
        ->whereNull('checkedin_at');;
    }
    
    public function cancelRequest($userId, $consumable_id, $cancelReason = null)
    {
        $checkoutRequest = $this->requests()->where('user_id', $userId)->where('consumable_id', $consumable_id)->first();
        ...
        $requestType = $checkoutRequest->itemType();
    ...
    // End Request Consumable Functionality
}